...
Route::post('/entrenamientos/dieta', ['uses' => 'TrainingController@DietPay', 'as' => 'dietStoreform']);
Route::post('/entrenamientos/todo', ['uses' => 'TrainingController@AllPay', 'as' => 'allStoreform']);
