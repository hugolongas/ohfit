...
@section('bodyClass','politica-privacidad')
@section('title','OhFit - Política de Privacidad')
@section('content')    
<div class="section-container">
    <div id="politica" class="container-fluid">
        <h1>Política de Privacidad</h1>
        <p>
            <strong>Oh-Fit</strong> te informa sobre su Política de Privacidad respecto del tratamiento y protección de los datos de carácter personal de los usuarios y clientes que puedan ser recabados por la navegación o contratación de servicios a través del sitio Web <strong>ohfit.barcelona</strong>.
        </p>
        <p>
        ...
        <ul>
            <li>Titular: <strong>Oh-Fit</strong></li>                        
            <li>NIF/CIF:<strong>B01677814</strong></li>
            <li>Domicilio:<strong>Carrer de Martí i Alsina, 9, 08031 Barcelona</strong></li>
            <li>Correo electrónico: <strong>info@ohfit.barcelona</strong></li>
            <li>Sitio Web: <strong>ohfit.barcelona</strong></li>
        </ul>
        ...
        <p>
            Para navegar por <strong>ohfit.barcelona</strong> no es necesario que facilites ningún dato personal. Los casos en los que sí proporcionas tus datos personales son los siguientes:
        </p>
        <ul>
            <li>
        ...
        <p>
            Para ejercitar tus derechos de acceso, rectificación, cancelación, portabilidad y oposición tienes que enviar un correo electrónico a <strong>info@ohfit.barcelona</strong> junto con la prueba válida en derecho como una fotocopia del D.N.I. o equivalente.
        </p>
        <p>
        ...
        <ul>
            ...
            <p>
                El sitio Web está alojado en <strong><a href="https://www.cdmon.com/es/" target="_blank">CDMON.COM - 10DENCEHISPAHARD S.L</a></strong> La seguridad de tus datos está garantizada, ya que toman todas las medidas de seguridad necesarias para ello. Puedes consultar su política de privacidad para tener más información.
            </p>
            ...
            <p>
            <a href="{{route('politica-cookies')}}" target="_blank">Política de cookies</a>
            </p>
            ...
            <p>
                ...
                <p>
                    Al navegar por <strong>ohfit.barcelona</strong> se pueden recoger datos no identificativos, que pueden incluir, la dirección IP, geolocalización, un registro de cómo se utilizan los servicios y sitios, hábitos de navegación y otros datos que no pueden ser utilizados para identificarte.
                </p>
                <p>
