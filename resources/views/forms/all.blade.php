...
<div class="alert alert-danger alert-container">
    <ul>
        ...
        <li>Debes indicar si sufres alguna patologia/enfermedad que pueda afectar negativamente a la práctica de tu
            actividad física</li>
        @endif
...
<div class="section-container">
    ...
    <form id="training_form" class="training-form" action="{{ route('trainingStoreform') }}" method="post">
            ...
            <div class="form-group  form-section">
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <input type="text" class="form-control" placeholder="Nombre y apellidos*" id="name" name="name"
                            value="{{ old('name') }}" />
                        @if($errors->has('name'))
                ...
                <div class="form-row">
                    ...
                    <div class="form-group  col-md-8">
                        <input type="text" class="form-control" placeholder="Dirección y código postal*" id="address"
        ...
        <fieldset>
            ...
            <div class="form-group form-section">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="Pérdida de peso" name="training_objective[]"
                        id="training_objective_1"
            ...
            <div class="form-group form-section">
                <textarea class="form-control" placeholder="Comentanos sobre tu objetivo" id="training_objective_info"
            ...
            <div class="form-group  form-section">
                ...
                <div class="form-check">
                    <label class="form-check-label">
                        <input type="text" class="form-control" name="training_body_other_value" placeholder="Otra..."
                            value="{{old('training_body_other_value')}}" />
                    </label>
                </div>
            </div>
            <div class="form-group  form-section">
            ...
            <div class="form-group  form-section">
                ...
                @endif
                <div class="form-check">
                    <input class="form-check-input" type="radio" value="30" name="training_time" id="training_time_1"
                        {{ old('training_time') == 30 ? 'checked' : ''}}>
                    <label class="form-check-label" for="training_time_1">
                        30 minutos
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" value="45" name="training_time" id="training_time_2"
                        {{ old('training_time') == 45 ? 'checked' : ''}}>
                    <label class="form-check-label" for="training_time_2">
                        45 minutos
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" value="60" name="training_time" id="training_time_3"
                        {{ old('training_time') == 60 ? 'checked' : ''}}>
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" value="90" name="training_time" id="training_time_5"
                        {{ old('training_time') == 90 ? 'checked' : ''}}>
        ...
        <fieldset>
            ...
            <div class="form-group  form-section">
                <textarea class="form-control" placeholder="¿Actualmente prácticas algun deporte?" id="training_sports"
                    name="training_sports">{{old('training_sports')}}</textarea>
            </div>
            <div class="form-group form-section">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" value="Principiante" name="training_experience"
                        id="training_experience_1" {{ old('training_experience') == "Principiante" ? 'checked' : ''}}>
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" value="Intermedio" name="training_experience"
                        id="training_experience_2" {{ old('training_experience') == "Intermedio" ? 'checked' : ''}}>
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" value="Avanzado" name="training_experience"
                        id="training_experience_3" {{ old('training_experience') == "Avanzado" ? 'checked' : ''}}>
        ...
        <fieldset>
            ...
            <div class="form-group  form-section">
                ...
                @if($errors->has('training_health'))
                <span class="error-message">Debes indicar si has sufrido alguna lesión en los últimos 3 meses</span>
                @endif
                <div class="form-check">
            ...
            <div class="form-group  form-section">
                <h4>¿Sufres alguna patologia/enfermedad que pueda afectar negativamente a la práctica de tu actividad
                    física?*</h4>
                @if($errors->has('training_disease'))
                <span class="error-message">Debes indicar si sufres alguna patologia/enfermedad que pueda afectar
        ...
        <fieldset>
            ...
            <div class="form-group form-section">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="Barra olímpica" name="training_material[]"
                        id="training_material_2"
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="Pelota medicinal" name="training_material[]"
                        id="training_material_6"
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="Cinta de correr" name="training_material[]"
                        id="training_material_9"
        ...
        <fieldset>
            ...
            <div class="form-group form-section">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="Dieta Vegetariana" name="diet_objective[]"
                        id="diet_objective_4"
                ...
                <div class="form-check">
                    <label class="form-check-label" for="diet_objective_7">
                        <input type="text" class="form-control" id="diet_objective_7" name="diet_objective_other_value"
                            placeholder="Otra..." value="{{old("diet_objective_other_value")}}" />
                    </label>
                </div>
            </div>
            <input type="button" name="previous" class="previous btn btn-default" value="Anterior" />
        ...
        <fieldset>
            ...
            <div class="form-group form-section">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="Cardiovascular" name="diet_fisic_activity[]"
                        id="diet_fisic_activity_1"
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="Readaptación" name="diet_fisic_activity[]"
                        id="diet_fisic_activity_2"
            ...
            <div class="form-group form-section">
                ...
                @if($errors->has('diet_training_frequency'))
                <span class="error-message">Selecciona cuantas horas de actividad física realizas a la semana</span>
                @endif
                <div class="form-check">
        ...
        <fieldset>
            ...
            <div class="form-group form-section">
                <input type="text" class="form-control" placeholder="Alergias e intolerancias" id="diet_alergic_text"
                    name="diet_alergic_text" />
            </div>
            <div class="form-group form-section">
        ...
        <fieldset>
            ...
            <div class="form-group form-section">
                ...
                <div class="form-group">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" value="1" name="diet_intakes" id="diet_intakes_1"
                            {{ old('diet_intakes') == 1 ? 'checked' : ''}}>
                        <label class="form-check-label" for="diet_intakes_1">
                            1
                        </label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" value="2" name="diet_intakes" id="diet_intakes_2"
                            {{ old('diet_intakes') == 2 ? 'checked' : ''}}>
                        <label class="form-check-label" for="diet_intakes_2">
                            2
                        </label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" value="3" name="diet_intakes" id="diet_intakes_3"
                            {{ old('diet_intakes') == 3 ? 'checked' : ''}}>
                        <label class="form-check-label" for="diet_intakes_3">
                            3
                        </label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" value="4" name="diet_intakes" id="diet_intakes_4"
                            {{ old('diet_intakes') == 4 ? 'checked' : ''}}>
                        <label class="form-check-label" for="diet_intakes_4">
                            4
                        </label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" value="5" name="diet_intakes" id="diet_intakes_5"
                            {{ old('diet_intakes') == 5 ? 'checked' : ''}}>
            ...
            <div class="form-group form-section">
                ...
                <div class="form-check">
                    ...
                    <label class="form-check-label" for="diet_eat_1" {{ old('diet_eat') == "Rápido" ? 'checked' : ''}}>
                        Rápido
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" value="Lento" name="diet_eat" id="diet_eat_2">
                    <label class="form-check-label" for="diet_eat_2" {{ old('diet_eat') == "Lento" ? 'checked' : ''}}>
                        Lento
                    </label>
                </div>
            </div>
        ...
        <fieldset>
            ...
            <div class="form-group form-section">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="Gimnasio de Glorias" name="how[]" id="how_4"
